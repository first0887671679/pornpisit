...
const covers = [
  {
    file: "pig-water-stain-removal-cover.svg",
    badge: "CAR CARE GUIDE",
    title: ["วิธีลบคราบน้ำฝังแน่น", "บนสีรถให้กลับมาเงาวับ"],
    subtitle: "เคล็ดลับง่ายๆ ขจัดคราบน้ำกวนใจโดยไม่ต้องง้อคาร์แคร์"
  },
  {
    file: "pig-scratch-removal-guide-cover.svg",
    badge: "PAINT REPAIR",
    title: ["ลบรอยขีดข่วนรถยนต์", "ทำเองได้ ไม่ต้องไปอู่"],
    subtitle: "วิธีลบรอยขนแมว รอยขูดขีดเบาๆ ให้หายวับในพริบตา"
  },
  {
    file: "pig-car-battery-price-2026-cover.svg",
    badge: "BATTERY PRICE",
    title: ["ราคาแบตเตอรี่รถยนต์", "อัปเดตใหม่ล่าสุด 2026"],
    subtitle: "เช็คราคาก่อนเปลี่ยน แบตแห้ง แบตกึ่งแห้ง ยี่ห้อไหนคุ้มสุด"
  }
];
