...
<div class="my-8">
  ...
  <p class="text-sm text-center text-slate-500 mt-2"><em>เคสจริง: ลูกค้าขับรถตกหลุมก่อสร้างแถวแบริ่งตอนตี 1 ยางหน้าซ้ายฉีก ช่าง PORNPISIT BATTERY เข้าช่วยเหลือใส่ยางอะไหล่ให้ เพื่อให้ลูกค้าขับรถกลับบ้านได้อย่างปลอดภัย</em></p>
</div>
...
<div class="not-prose relative overflow-hidden bg-gradient-to-br from-orange-50 via-white to-amber-50 dark:from-slate-800 dark:via-slate-900 dark:to-slate-800 p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl border border-orange-200/60 dark:border-orange-500/20 text-center my-8 sm:my-10 shadow-lg shadow-orange-100/50 dark:shadow-orange-900/10">
  ...
  <div class="relative z-10 max-w-2xl mx-auto">
    ...
    <p class="text-slate-600 dark:text-slate-300 mb-6 sm:mb-8 text-sm sm:text-base md:text-lg leading-relaxed">จอดเสียในที่มืดมันอันตราย! PORNPISIT BATTERY พร้อมส่งช่างไป <strong>เปลี่ยนยางอะไหล่ให้ถึงที่</strong> โซนศรีนครินทร์ บางนา แบริ่ง ลาซาล เทพารักษ์ แพรกษา ถึงไวใน 30 นาที</p>
...
const postData = {
  ...
  published: true,
  seoTitle: "ตกหลุมยางแตก แก้มยางฉีก แม็กดุ้ง ปะได้ไหม วิธีแก้ | PORNPISIT BATTERY",
