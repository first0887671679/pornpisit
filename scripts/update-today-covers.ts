...
${pigMascotDef}
  ...
  <g transform="translate(80, 200)">
    ...
    <text x="140" y="-55" font-size="15" font-weight="800" fill="#FF6B00" text-anchor="middle" letter-spacing="2">${data.badge}</text>

    <text x="0" y="20" font-size="60" font-weight="800" fill="url(#text-grad)">${data.title1}</text>
    <text x="0" y="95" font-size="52" font-weight="800" fill="#FFFFFF">${data.title2}</text>

    <rect x="0" y="140" width="8" height="30" rx="4" fill="url(#primary-grad)"/>
    <text x="24" y="164" font-size="26" font-weight="600" fill="#94A3B8">${data.desc}</text>
  </g>
...
const covers = [
  {
    file: "pig-honda-city-battery-cover.svg",
    badge: "BATTERY REPLACEMENT",
    title1: "แบตเตอรี่ Honda City",
    title2: "แบตเสื่อม สตาร์ทไม่ติด ทำไงดี?",
    desc: "รีวิวเปลี่ยนแบตด่วนนอกสถานที่ พร้อมวิธีเลือกแบต EFB"
  },
  {
    file: "pig-vios-battery-cover.svg",
    badge: "BATTERY REPLACEMENT",
    title1: "แบตเตอรี่ Toyota Vios",
    title2: "หมดกลางทาง แก้ยังไง?",
    desc: "รีวิวเปลี่ยนแบตด่วนถึงที่ แนะนำรุ่น 46B24L พร้อมราคา"
  },
  {
    file: "pig-dead-battery-alley-cover.svg",
    badge: "EMERGENCY GUIDE",
    title1: "รถแบตหมดในซอย",
    title2: "จอดขวางทาง ทำยังไงดี?",
    desc: "รีวิวเรียกช่างเปลี่ยนแบต 24 ชม. ซอยแคบแค่ไหนก็ไปถึง!"
  },
  {
    file: "pig-alternator-100k-cover.svg",
    badge: "ALTERNATOR REPAIR",
    title1: "ไดชาร์จเสีย 100,000 โล",
    title2: "รถดับกลางทาง แก้ยังไง?",
    desc: "เจาะลึกอาการ สาเหตุ ซ่อมหรือเปลี่ยนดี? รีวิวราคาจริง"
  },
  {
    file: "pig-starter-symptoms-cover.svg",
    badge: "STARTER MOTOR",
    title1: "ไดสตาร์ทพัง อาการ",
    title2: "เป็นแบบไหน? เช็กเองได้!",
    desc: "บิดกุญแจเงียบ เสียงแชะๆ วิธีเช็กเบื้องต้น + รีวิวซ่อมจริง"
  },
  {
    file: "pig-check-engine-light-cover.svg",
    badge: "CHECK ENGINE LIGHT",
    title1: "ไฟรูปเครื่องโชว์",
    title2: "ขับต่อได้ไหม? อันตรายไหม?",
    desc: "สาเหตุ วิธีเช็กเบื้องต้น + รีวิวสแกนโค้ด OBD2 แก้ไขจริง"
  }
];
