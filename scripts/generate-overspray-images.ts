...
const coverData = {
  file: "pig-overspray-removal-cover.svg",
  badge: "PAINT CORRECTION",
  title: ["ลบรอยละอองสีเกาะรถ", "สากทั้งคัน แก้ยังไง?"],
  subtitle: "วิธีเอาละอองสีออก ไม่ทำลายสีรถ 100% โซนบางนา แบริ่ง"
};

const infoData = {
  file: "pig-overspray-removal-info.svg",
  title: "3 ข้อห้ามเด็ดขาด! เมื่อรถโดนละอองสีเกาะ",
  items: [
    { num: "01", title: "ห้ามใช้ทินเนอร์เช็ด", desc: ["ทินเนอร์มีความรุนแรงสูงมาก", "จะละลายทั้งคราบละอองสี", "และละลายชั้นแลคเกอร์ของรถ", "ทำให้สีรถด่างเป็นดวงถาวร"] },
    { num: "02", title: "ห้ามขัดด้วยสก๊อตไบรต์", desc: ["ฟองน้ำล้างจานมีผิวที่หยาบเกินไป", "ถ้าเอามาถูกับสีรถโดยตรง", "จะเกิดรอยขีดข่วนลึกทั่วคัน", "ยิ่งทำให้รถหมองและแก้รอยยาก"] },
    { num: "03", title: "ต้องลูบดินน้ำมันเท่านั้น", desc: ["วิธีที่ปลอดภัยที่สุดคือดินน้ำมันรถ", "ใช้น้ำยาหล่อลื่นควบคู่ไปกับการลูบ", "ดึงละอองสีออกทีละนิดไม่ทำลายสี", "ควรให้ร้านขัดสีรถผู้เชี่ยวชาญทำ"] }
  ]
};
