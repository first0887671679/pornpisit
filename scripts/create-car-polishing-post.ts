...
const htmlContent = `
<p class="lead">การ<strong>ขัดสีรถก่อนขาย</strong>เป็นหนึ่งในเคล็ดลับที่เต็นท์รถมือสองใช้เพื่ออัปราคาตัวรถให้ดูใหม่และดึงดูดสายตาคนซื้อ วันนี้ PORNPISIT BATTERY จะพามาดูเคสรีวิวผลงานการเตรียมสภาพรถก่อนขายที่ช่วยให้ลูกค้าในโซน<strong>ศรีนครินทร์ บางนา แบริ่ง ลาซาล</strong> สามารถขายรถได้ไวขึ้นและได้ราคาดีกว่าเดิม รวมถึงเทคนิคการขจัดคราบฝังลึกเฉพาะทางที่คุณอาจไม่เคยรู้มาก่อน</p>
...
<p>สัปดาห์ที่ผ่านมา ทีมงาน PORNPISIT BATTERY ได้รับเคสจากลูกค้าที่คอนโดแถว<strong>สถานีรถไฟฟ้าแบริ่ง</strong> ลูกค้าต้องการขายรถ Honda Civic สีดำ ปี 2018 แต่ปัญหาคือรถมีรอยขนแมวเต็มคัน (จากการเช็ดฝุ่นด้วยผ้าแห้ง) และมีคราบน้ำด่างๆ บนฝากระโปรง ลูกค้าโดนเต็นท์กดราคาไปเกือบ 30,000 บาท ด้วยเหตุผลเรื่องสีรถ</p>
...
<h2>รวมบริการฟื้นฟูสภาพรถก่อนขายจาก PORNPISIT BATTERY</h2>
