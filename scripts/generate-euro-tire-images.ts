...
${DEFS}
  ...
  <g transform="translate(80, 200)">
    <rect x="0" y="-80" width="340" height="40" rx="20" fill="url(#glass-grad)" stroke="#FF6B00" stroke-width="1.5"/>
    <text x="170" y="-55" font-size="15" font-weight="800" fill="#FF6B00" text-anchor="middle" letter-spacing="2">\${data.badge}</text>
...
const coverData = {
  file: "pig-european-tire-repair-cover.svg",
  badge: "EUROPEAN CAR SERVICE",
  title: ["ปะยางรถยุโรป รันแฟลต", "ผู้หญิงยางแตก ทำไงดี?"],
  subtitle: "รีวิวเคสจริง ปะยางนอกสถานที่ 24 ชม. โซนศรีนครินทร์"
};

const infoData = {
  file: "pig-european-tire-repair-info.svg",
  title: "3 ข้อควรรู้เมื่อรถยุโรปยางแตก (Runflat)",
  items: [
