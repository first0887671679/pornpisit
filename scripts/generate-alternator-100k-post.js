...
const coverSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 630" width="1200" height="630">
  ...
  <g transform="translate(80, 180)">
    ...
    <text x="0" y="208" font-family="Prompt, sans-serif" font-size="28" font-weight="400" fill="#94A3B8">รีวิวจากโซนบางนา ศรีนครินทร์ สมุทรปราการ</text>
  </g>
...
const post = {
  ...
  excerpt: "ไดชาร์จเสียที่ 100,000 โล เป็นเรื่องปกติไหม? มีอาการอะไร? ซ่อมหรือเปลี่ยนดี ราคาเท่าไหร่? อ่านเคสรีวิวจริงจากโซนบางนา ศรีนครินทร์ เทพารักษ์ พร้อมวิธีเช็กเบื้องต้น",
  category: "ซ่อมบำรุง",
  ...
  seoDescription: "ไดชาร์จเสียที่ 100,000 กม. ไฟไม่ชาร์จ รถดับกลางทาง? ดูอาการ สาเหตุ ราคาซ่อม และรีวิวเคสจริงจากช่างโซนบางนา ศรีนครินทร์ เทพารักษ์",
...
<p>ลูกค้าโทรหา FirstCarCenter ช่างของเราวิ่งมอเตอร์ไซค์ออกจากฐานย่าน <strong>บางนา</strong> ไปถึงจุดเกิดเหตุใน <strong>22 นาที</strong> ช่างใช้มิเตอร์วัดไฟที่ขั้วแบตเตอรี่ขณะสตาร์ทเครื่อง (จัมป์สตาร์ทก่อน) ได้แรงดันไฟเพียง <strong>11.8 โวลต์</strong> — ยืนยันชัดเจนว่าไดชาร์จไม่ทำงานแล้ว (ปกติต้องได้ 13.5 - 14.5V)</p>
...
<h2>รถวิ่งเกินแสนโล ไดชาร์จมีปัญหา? เรียก FirstCarCenter ได้เลย</h2>
<p>ไม่ว่ารถจะเสียแถว <strong>แยกบางนา ศรีนครินทร์ หน้าซีคอนสแควร์ เซ็นทรัลบางนา</strong> หรือลึกเข้าไปใน <strong>สุขุมวิท 105 (ลาซาล) แบริ่ง เทพารักษ์ แพรกษา สมุทรปราการ</strong> ช่างของเรามีเครื่องมือและอะไหล่พร้อม สามารถวินิจฉัยและซ่อมไดชาร์จได้หน้างานทันที ไม่ต้องลากรถไปอู่ ไม่ต้องจ่ายค่ารถสไลด์ให้เปลืองเงินครับ</p>
...
<div style="background: linear-gradient(135deg, #fff7ed 0%, #fff 40%, #f0fdfa 100%); border: 1px solid #fed7aa; border-radius: 2rem; padding: 2.5rem 1.5rem; margin: 2.5rem 0; text-align: center; position: relative; overflow: hidden; box-shadow: 0 25px 60px -20px rgba(0,0,0,0.08);">
  ...
  <div style="position:relative;">
    ...
    <p style="margin-top:1.5rem;"><a href="/alternator-starter" style="color:#ea580c;font-weight:500;text-decoration:underline;text-underline-offset:4px;font-size:1rem;">บริการซ่อมไดชาร์จ ไดสตาร์ท นอกสถานที่ บางนา ศรีนครินทร์</a></p>
...
<div class="space-y-4 my-8" itemscope itemtype="https://schema.org/FAQPage">
  ...
  <div class="border rounded-xl p-4" itemprop="mainEntity" itemscope itemtype="https://schema.org/Question">
    ...
    <div itemprop="acceptedAnswer" itemscope itemtype="https://schema.org/Answer">
      <p class="mb-0 text-slate-600" itemprop="text"><strong>A:</strong> ได้จริงครับ! ช่าง FirstCarCenter สามารถถอดไดชาร์จ ตรวจวินิจฉัย และซ่อม (เปลี่ยนแปรงถ่าน เร็กกูเลเตอร์ ลูกปืน) ได้ที่หน้างานเลย โดยไม่ต้องนำรถเข้าอู่ ให้บริการในพื้นที่ ศรีนครินทร์ บางนา แบริ่ง ลาซาล เทพารักษ์ แพรกษา สมุทรปราการ ตลอด 24 ชั่วโมงครับ</p>
    </div>
  </div>
