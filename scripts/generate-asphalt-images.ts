...
const coverData = {
  file: "pig-asphalt-stain-removal-cover.svg",
  badge: "PAINT PROTECTION",
  title: ["คราบยางมะตอยเกาะรถ", "ปล่อยไว้รถหมอง ราคาตก!"],
  subtitle: "วิธีขจัดคราบยางมะตอย ไม่ทำลายสีรถ โซนศรีนครินทร์"
};

const infoData = {
  file: "pig-asphalt-stain-removal-info.svg",
  title: "ทำไมคราบยางมะตอยถึงอันตรายต่อสีรถ?",
  items: [
    { num: "01", title: "ละลายแลคเกอร์รถ", desc: ["ยางมะตอยมีความร้อนและสารเคมี", "หากเกาะนานจะซึมลึกเข้าสู่ชั้นสี", "ทำให้แลคเกอร์ด้านและด่าง", "ล้างด้วยแชมพูทั่วไปไม่ออก"] },
    { num: "02", title: "สีรถหมอง ราคาตก", desc: ["โดยเฉพาะรถสีขาวและสีอ่อน", "จะเป็นจุดดำน่าเกลียดรอบคัน", "เมื่อนำไปตีเทิร์นหรือขายเต็นท์", "จะโดนกดราคาอ้างว่าต้องทำสีใหม่"] },
    { num: "03", title: "ห้ามขูดหรือใช้ของแข็งแคะ", desc: ["ห้ามใช้เล็บหรือของมีคมขูดเด็ดขาด", "จะทำให้สีรถเป็นรอยลึกจนต้องทำสี", "ต้องใช้น้ำยาขจัดยางมะตอยโดยเฉพาะ", "และลูบด้วยดินน้ำมันเท่านั้น"] }
  ]
};
