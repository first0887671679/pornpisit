...
<p>หลายครั้งที่ลูกค้าโทรเรียกช่าง PORNPISIT BATTERY ไปพ่วงแบตเตอรี่แถว <strong>ศรีนครินทร์</strong> หรือ <strong>บางนา</strong> เพราะคิดว่ารถแบตหมด แต่พอไปถึงหน้างาน เช็กไปเช็กมา อ้าว... กลายเป็น "ไดชาร์จพัง" ซะงั้น! อาการของแบตเตอรี่เสื่อมกับไดชาร์จเสียมันคล้ายกันมากครับ คือรถสตาร์ทไม่ติดเหมือนกัน</p>
