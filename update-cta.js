...
const ctaRegex = /<div class="bg-slate-50 p-6 rounded-2xl border border-slate-200 text-center my-8">\s*<h2 class="text-2xl font-bold text-slate-800 mb-4">([\s\S]*?)<\/h2>\s*<p class="text-slate-600 mb-6">([\s\S]*?)<\/p>\s*<div class="flex flex-col sm:flex-row gap-4 justify-center">\s*<a href="tel:0887671679"[^>]*>\s*📞\s*([\s\S]*?)\s*<\/a>\s*<a href="https:\/\/lin\.ee\/xxqKaZn"[^>]*>\s*💬\s*([\s\S]*?)\s*<\/a>\s*<\/div>\s*<\/div>/g;
