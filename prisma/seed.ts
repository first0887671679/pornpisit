...
async function main() {
  ...
  await prisma.contactInfo.upsert({
    ...
    create: {
      ...
      phone: '0800000000',
      lineId: '@398kyxfq',
      lineUrl: 'https://line.me/ti/p/~@398kyxfq',
    ...
    await (prisma as any).pageSection.create({
      data: {
        ...
        content: JSON.stringify({
          ...
          subheading: 'ด่วนทันใจ โซนห้วยขวาง ดินแดง ลาดพร้าว',
    ...
    await (prisma as any).pageSection.create({
      data: {
        ...
        content: JSON.stringify({
          ...
          subheading: 'เปลี่ยนแบตด่วน 24 ชม. ห้วยขวาง ดินแดง ลาดพร้าว',
    ...
    await (prisma as any).pageSection.create({
      data: {
        ...
        content: JSON.stringify({
          ...
          subheading: 'ด่วน โซนห้วยขวาง ดินแดง ลาดพร้าว',
    ...
    await (prisma as any).pageSection.create({
      data: {
        ...
        content: JSON.stringify({
          ...
          subheading: 'นอกสถานที่ ถึงบ้าน โซนห้วยขวาง ดินแดง ลาดพร้าว',
